...
\}"
            ...
            describe "expression" $ do
                ...
                it "can parse call expressions"
                    $             expression "test;"
                    `shouldParse` P.CallExpr [P.IdfCall "test"]
